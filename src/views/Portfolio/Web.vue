        ...
        <v-card v-if="project.dialog">
          ...
          <v-card-actions>
            <v-btn
              ...
              target="_blank"
            >
              <v-icon left>fa fa-code</v-icon>Source Code
            </v-btn>
            <v-btn
              large
              flat
...
export default {
  metaInfo: {
    title: "Web Portfolio",
    titleTemplate: "%s | Citra Mirna",
    meta: [
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      { name: "description", content: "Citra Mirna Portfolio" },
      { charset: "utf-8" },
      { property: "og:title", content: "Citra Mirna" },
      { property: "og:site_name", content: "Citra Mirna" },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://citramrn.github.io" },
    ],
  },
  data() {
    return {
      ...
      projects: [
        ...
        {
          dialog: false,
          title: "Label Generator Tool",
          git: "https://drive.google.com/drive/folders/1sUuQXww5N40RdYOgDQWynW2-55uthvLZ?usp=sharing",
          demo: "https://drive.google.com/file/d/1oRw1ATUYHNZF4VTqi4Ed7KbkKBVJFWWi/view?usp=sharing",
          tech: {
            tech1: "HTML",
            tech2: "CSS",
            tech3: "JavaScript",
          ...
          poster: "https://i.ibb.co/5LDXWPr/Capture.png",
        },
      ],
    };
  },
